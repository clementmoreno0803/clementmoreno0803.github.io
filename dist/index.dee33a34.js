...
})({"8UuSm":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "9a5296a2dee33a34";
"use strict";
...
},{}],"2wQFf":[function(require,module,exports) {
...
const initBorderNav = ()=>{
    if (navbar) window.addEventListener('scroll', ()=>{
        if (window.scrollY > 365) navbar.classList.add('active');
        else navbar.classList.remove('active');
    });
};
exports.default = initBorderNav;
...
},{}],"H2Iak":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initSwitchColors", ()=>initSwitchColors
);
const initSwitchColors = ()=>{
    const theme = [
        'theme1',
        'theme2',
        'theme3',
    ...
    document.body.addEventListener('click', ()=>{
        ...
        while(previousNumber === randomNumber)randomNumber = Math.floor(Math.random() * 5);
...
exports.default = initSwitchColors;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"2UH2g":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initWorkRotation", ()=>initWorkRotation
);
const work = document.querySelectorAll('.asset');
const initWorkRotation = ()=>{
    if (work) window.addEventListener('scroll', ()=>{
        if (window.scrollY > 1200) work.forEach((e)=>{
...
//# sourceMappingURL=index.dee33a34.js.map
